...
class Receive(threading.Thread):
    #Listens for incoming messages form the server
    def __init__(self, sock, name):
        super().__init__()
        self.sock = sock
        self.name = name
...
def main(host, port):
    ...
    btnSend.grid(row=1, column=1, pady=10, padx=10, sticky="ew")
...
if __name__ == "__main__":
    ...
    parser.add_argument('host', help='Interfact the server listens at')
